...
const postEducation = async (req, res) => {
  try {
    if (!req.body.school) {
      res.status(400).json({ status: false, message: "school is missing" });
      ...
      res
        .status(200)
        .json({ status: true, message: "details saved successfully",data:result});
    }
  } catch (e) {
    res.status(500).json({ status: false, message: e.toString() });
  }
...
const postExperience = async (req, res) => {
  try {
    if (!req.body.company) {
      ...
      res
        .status(400)
        .json({ status: false, message: "currently working is missing" });
    } else if (!req.body.location) {
      res.status(400).json({ status: false, message: "location is missing" });
    } else {
...
const updateExperience = async (req, res) => {
  try {
    if (!req.body.company) {
      ...
      res.status(400).json({ status: false, message: "currently working is missing" });
    } else if (!req.body.location) {
      res.status(400).json({ status: false, message: "location is missing" });
    } else if (!req.body.id) {
